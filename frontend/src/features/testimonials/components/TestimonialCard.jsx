...
import TestimonialCMSicon from "../../../../src/assets/TestimonialCMSicon.svg"
...
{hasVideo && (
  <button
    ...
    className="absolute bottom-3 right-3 bg-gray/20 backdrop-blur-md p-3 rounded-full hover:bg-gray/70 transition-all hover:scale-110 z-10"
...
{!hasImage && hasVideo && (
  ...
  >
    <img
      src={youtubeId ? `https://img.youtube.com/vi/${youtubeId}/default.jpg` : TestimonialCMSicon}
      alt="Video thumbnail"
